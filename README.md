...
+ 사용기술 Android Sudio, Java, XML
 ...
 <img src="images/채팅어플_가입_로그인.gif" width="20%" height="10%">{: .assz}
 <img src="images/Java_채팅어플 -프로필변경.gif" width="20%" height="10%">{.1234}
 <img src="images/Java_채팅어플 - Join.gif" width="20%" height="10%">{:fsasz}
